        ...
        <div className='container'>
            ...
            gap-6 items-center'>
                ...
                <div className='flex flex-col justify-center gap-6 sm:pt-0'>
                    ...
                    leading-5 '>
                        Beat the heat with hot deals! Enjoy up to 50% OFF on your favorite styles this summer. Limited time only!
                    </p>
                    <div className='flex flex-col gap-4'>
                        ...
                        <div data-aos="fade-up" className='flex items-center gap-4'>
                            <IoFastFood className='text-6xl h-122 w-12 shadow-sm p-4 
                            rounded-full bg-orange-100 dark:bg-orange-400' />
                            <p>Fast Delivery</p>
                        </div>
                        <div data-aos="fade-up" className='flex items-center gap-4'>
                            <GiFoodTruck className='text-6xl h-122 w-12 shadow-sm p-4 
